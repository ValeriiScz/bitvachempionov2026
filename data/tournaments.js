  ...
  "tournaments": [
    {
      ...
      "sections": [
        ...
        {"href": "results.html?t=693", "title": "Игры с результатами", "desc": "Все 15 игр × 2 стола: роли, допы, победители"},
        {"href": "standings.html?t=693", "title": "Команды и сводная", "desc": "Зачёт по командам и по игрокам (переключатель), Σ и роли"},
        {"href": "player.html?t=693", "title": "Статистика игрока", "desc": "Маршруты, роли, соперники и зачёт каждого игрока"}
      ]
    },
    {
      "id": "766",
      ...
      "status": "upcoming",
      "phase": 3,
      "statusLabel": "Скоро начнётся · старт 27 июня",
      "eloAvg": 1009, "eloN": 30, "eloTotal": 40,
      "organizer": "Four Seasons",
      "mafgame": "https://mafgame.org/tournaments/766/view",
      "store": {
        "url": "https://open-mafia.world/mafia_store?id=ca59cceb-1da9-4844-97c8-5956a0c70a41",
        "title": "Магазин и интерактивы",
        "intro": "На турнире работает магазин лотов за внутренние «коинсы» 🪙.",
        "lots": "Лоты: вкусности, игрушки, пиво на афтепати, игровой вечер в Family Mafia Club, музыка на договорке, массаж от г-на Пудинга, фото с кубками, преимущество на квизе — плюс лоты от спонсоров.",
        "earn": "Коинсы зарабатываются 10 способами: допы, бинго (электронное / бумажное), загадка, челендж, квиз, медиа, ставки на турнир, ставки на финал, донат (1$ = 10 коинсов) и бонус первым 10 оплатившим (+50 за факты о себе и фото на бейдж)."
      },
      ...
      "sections": [
        {"href": "participants.html?t=766", "title": "Участники и рейтинг", "desc": "Заявки mafgame + ELO (markery / mafiastats), ожидаемый средний рейтинг состава"},
        {"href": "seating766.html", "title": "Интерактивная рассадка", "desc": "12 игр × 4 стола: клик по игроку — весь его маршрут по турниру"},
        {"href": "cards766.html", "title": "Карточки игроков", "desc": "40 карточек: фото, ELO (markery), столы, слоты, соперники. Сортировка по ELO ↓"},
        {"href": "markers.html?t=766", "title": "Совместные посадки", "desc": "Матрица: кто с кем сколько раз за одним столом"},
        {"href": "results.html?t=766", "title": "Игры с результатами", "desc": "Раунды и столы; до старта — рассадка, результаты появятся вживую"},
        {"href": "standings.html?t=766", "title": "Сводная таблица", "desc": "Σ, роли, динамика — появится после первой игры"},
        {"href": "roles.html?t=766", "title": "Статистика по ролям", "desc": "Σ по ролям: мирный, шериф, мафия, дон — после старта"},
        {"href": "player.html?t=766", "title": "Статистика игрока", "desc": "Маршруты, роли, соперники и зачёт каждого игрока"}
      ]
    },
    {
      "id": "702",
