// MafgameStat · data/tournaments.js · v1.5 · 2026-06-14 · реестр турниров (источник правды для index.html и tournament.html); 667 в live, подключены все разделы (результаты, сводная, статистика игрока)
  ...
  "tournaments": [
    {
      ...
      "sections": [
        ...
        {"href": "standings.html?t=667", "title": "Статистика турнира", "desc": "Сводная таблица + срез «после игры N», победы красных/чёрных, разбивка по ролям R / S / B / D"},
        {"href": "results.html?t=667", "title": "Игры с результатами", "desc": "Раунд → все 7 столов: роли, допы, победители, фото, стримы"},
        {"href": "player.html?t=667", "title": "Статистика игрока", "desc": "Место после каждой игры, стата по 4 ролям, сравнение с топ-10, 11–20 и средним по турниру"},
        {"href": "roles.html?t=667", "title": "Статистика по ролям", "desc": "Σ по ролям: мирный, шериф, мафия, дон; рейтинг внутри каждой роли"}
      ]
    },
    {
      "id": "826",
