/* ============================================================================
   MafgameStat · sw.js (Service Worker для PWA) · v1.10 · 2026-08-26 (кэш v18.1: calendar.html v1.1 — заявки+подтверждённые, составы прошедших)
...
const CACHE_VERSION = 'mafgamestat-v18.1';
